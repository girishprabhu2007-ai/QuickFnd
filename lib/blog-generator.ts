...
const SEED_BANK: BlogGenerationInput[] = [
  ...
  { keyword: "how to prettify minified javascript online", tool_slug: "json-formatter", tool_name: "JSON Formatter", related_tool_slugs: ["css-minifier"] },
  ...
  { keyword: "how to inspect jwt claims without a backend", tool_slug: "jwt-decoder", tool_name: "JWT Decoder", related_tool_slugs: ["base64-encoder"] },
  ...
  { keyword: "how to choose a color palette for your website", tool_slug: "color-picker", tool_name: "Color Picker", related_tool_slugs: ["color-contrast-checker", "css-gradient-generator"] },
  { keyword: "css variables for colors complete guide", tool_slug: "color-picker", tool_name: "Color Picker", related_tool_slugs: ["css-gradient-generator"] },
  { keyword: "tailwind css color system explained", tool_slug: "color-contrast-checker", tool_name: "Color Contrast Checker", related_tool_slugs: ["hex-to-rgb"] },
  { keyword: "how to create a dark mode color scheme", tool_slug: "color-contrast-checker", tool_name: "Color Contrast Checker", related_tool_slugs: ["color-picker"] },
  { keyword: "css flexbox vs grid which layout to use", tool_slug: "css-gradient-generator", tool_name: "CSS Gradient Generator", related_tool_slugs: [] },
  { keyword: "how to make responsive buttons with pure css", tool_slug: "box-shadow-generator", tool_name: "Box Shadow Generator", related_tool_slugs: ["css-gradient-generator"] },
  { keyword: "color theory basics every designer should know", tool_slug: "color-picker", tool_name: "Color Picker", related_tool_slugs: ["color-contrast-checker"] },
  ...
  { keyword: "how to sort a list alphabetically online", tool_slug: "line-sorter", tool_name: "Line Counter & Sorter", related_tool_slugs: [] },
  { keyword: "how to find and replace text in a large file", tool_slug: "diff-checker", tool_name: "Text Diff Checker", related_tool_slugs: ["word-counter"] },
  ...
  { keyword: "how to calculate percentage increase decrease", tool_slug: "percentage-calculator", tool_name: "Percentage Calculator", related_tool_slugs: ["discount-calculator"] },
  { keyword: "percentage calculator real world uses explained", tool_slug: "percentage-calculator", tool_name: "Percentage Calculator", related_tool_slugs: ["discount-calculator"] },
  ...
  { keyword: "on page seo checklist for beginners 2026", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: ["open-graph-tester", "slug-generator"] },
  { keyword: "how to optimize meta tags for google ranking", tool_slug: "open-graph-tester", tool_name: "Open Graph Tester", related_tool_slugs: [] },
  { keyword: "how to create xml sitemap for your website", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: [] },
  { keyword: "core web vitals explained and how to improve them", tool_slug: "html-minifier", tool_name: "HTML Minifier", related_tool_slugs: ["css-minifier"] },
  { keyword: "how to improve website page speed in 2026", tool_slug: "html-minifier", tool_name: "HTML Minifier", related_tool_slugs: ["css-minifier"] },
  { keyword: "what is canonical url and when to use it", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: ["slug-generator"] },
  ...
  { keyword: "how to build backlinks for a new website", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: [] },
  { keyword: "technical seo audit checklist 2026", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: ["html-minifier"] },
  // ── Unit Converters ──
  ...
  { keyword: "how to schedule meetings across time zones", tool_slug: "timestamp-converter", tool_name: "Unix Timestamp Converter", related_tool_slugs: ["cron-builder"] },
  ...
  { keyword: "best free developer tools for 2026 no install needed", tool_slug: "json-formatter", tool_name: "JSON Formatter", related_tool_slugs: ["regex-tester", "uuid-generator", "jwt-decoder", "base64-encoder"] },
  ...
  { keyword: "free seo tools for beginners complete guide 2026", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: ["open-graph-tester", "slug-generator"] },
  ...
  { keyword: "best tools for frontend developers 2026", tool_slug: "color-contrast-checker", tool_name: "Color Contrast Checker", related_tool_slugs: ["css-gradient-generator", "box-shadow-generator", "hex-to-rgb"] },
  ...
  { keyword: "free tools to improve website seo in 2026", tool_slug: "robots-txt-generator", tool_name: "Robots.txt Generator", related_tool_slugs: ["open-graph-tester"] },
];
