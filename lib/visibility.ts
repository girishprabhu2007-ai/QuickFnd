...
const TOOL_HARD_HIDDEN = new Set<string>([
  ...
  // ── Phase 1 consolidation: 73 duplicate/platform variants ────────────────
  // These redirect to canonical tools via next.config.ts
  // Hidden here as belt-and-suspenders while DB cleanup runs
  "advanced-text-summarizer",
  "automatic-text-language-detector",
  "base64-instagram-caption-encoder",
  "base64-text-visualizer",
  "call-to-action-text-transformer",
  "case-conversion-with-custom-rules",
  "compact-json-minifier",
  "content-hash-generator",
  "custom-regex-pattern-builder",
  "hashtag-word-counter",
  "human-readable-password-generator",
  "ig-story-url-encoder",
  "instagram-bio-slug-maker",
  "instagram-caption-text-case",
  "instagram-image-hex-to-rgb",
  "instagram-post-uuid-generator",
  "json-code-beautifier",
  "json-seo-schema-formatter",
  "keyword-slug-generator",
  "lowercase-text-converter",
  "md5-sha256-dual-hasher",
  "meta-description-creator",
  "meta-description-length-checker",
  "meta-description-transformer",
  "random-pronounceable-password-generator",
  "random-seo-meta-tag-generator",
  "secure-password-creator",
  "sentence-case-converter",
  "seo-keyword-case-converter",
  "seo-keyword-counter",
  "seo-keyword-density-checker",
  "seo-keyword-slug-generator",
  "seo-title-length-counter",
  "seo-title-optimizer",
  "slug-batch-generator",
  "smart-word-counter",
  "social-media-hashtag-slug-generator",
  "story-highlight-password-checker",
  "text-entropy-analyzer",
  "text-similarity-comparator",
  "thumbnail-text-case-converter",
  "title-case-transformer",
  "tweet-random-string-generator",
  "tweet-timestamp-converter",
  "twitter-binary-to-text-converter",
  "twitter-bio-base64-decoder",
  "twitter-bio-base64-encoder",
  "twitter-bio-word-counter",
  "twitter-content-json-formatter",
  "twitter-hashtag-analyzer",
  "twitter-profile-md5-hasher",
  "twitter-sha256-hash-generator",
  "twitter-text-to-binary-converter",
  "twitter-tweet-text-case-converter",
  "twitter-url-encoder",
  "twitter-username-slug-generator",
  "twitter-uuid-generator-for-tweets",
  "unicode-character-inspector",
  "uppercase-text-converter",
  "uuid-version-4-generator",
  "video-tag-text-transformer",
  "video-title-word-counter",
  "youtube-comment-word-counter",
  "youtube-description-case-converter",
  "youtube-description-word-counter",
  "youtube-slug-generator",
  "youtube-timestamp-converter",
  "youtube-title-case-converter",
  "youtube-video-id-extractor",
  "youtube-video-md5-hasher",
  "youtube-video-slug-generator",
  "youtube-video-url-decoder",
  "youtube-video-url-encoder",
]);
