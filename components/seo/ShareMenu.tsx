...
function baseButtonClass() {
  return "group inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-semibold transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-sm active:translate-y-0";
}

function neutralButtonClass() {
  return `${baseButtonClass()} border-q-border bg-q-card text-q-text hover:bg-q-card-hover`;
}

function brandButtonClass(brand: "x" | "facebook" | "linkedin" | "whatsapp" | "telegram") {
  const map = {
    x: "border-zinc-300 bg-white text-zinc-700 hover:border-black hover:text-black",
    facebook:
      "border-sky-200 bg-white text-sky-600 hover:border-sky-500 hover:bg-sky-50 hover:text-sky-700",
    linkedin:
      "border-blue-200 bg-white text-blue-600 hover:border-blue-600 hover:bg-blue-50 hover:text-blue-700",
    whatsapp:
      "border-green-200 bg-white text-green-600 hover:border-green-500 hover:bg-green-50 hover:text-green-700",
    telegram:
      "border-cyan-200 bg-white text-cyan-600 hover:border-cyan-500 hover:bg-cyan-50 hover:text-cyan-700",
  };

  return `${baseButtonClass()} ${map[brand]}`;
}
    ...
    <div className="mt-6 rounded-2xl border border-q-border bg-q-bg p-4">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            onClick={nativeShare}
            className="group inline-flex items-center gap-2 rounded-xl bg-q-primary px-4 py-2 text-sm font-semibold text-white transition-all duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:bg-q-primary-hover hover:shadow-sm active:translate-y-0"
            type="button"
          >
          ...
          <button
            onClick={copyLink}
            className={`${neutralButtonClass()} ${copied ? "border-emerald-400 text-emerald-700" : ""}`}
            type="button"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={brandButtonClass("facebook")}
          >
            <span className="transition-transform duration-200 group-hover:scale-110 group-hover:-rotate-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={brandButtonClass("linkedin")}
          >
            <span className="transition-transform duration-200 group-hover:scale-110 group-hover:-rotate-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={brandButtonClass("whatsapp")}
          >
            <span className="transition-transform duration-200 group-hover:scale-110 group-hover:rotate-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={brandButtonClass("telegram")}
          >
            <span className="transition-transform duration-200 group-hover:scale-110 group-hover:rotate-3">
