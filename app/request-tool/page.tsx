...
export default function RequestToolPage() {
  ...
  const [requestedCategory, setRequestedCategory] = useState("tool");
      ...
      <section className="mx-auto max-w-3xl">
        <div className="rounded-3xl border border-q-border bg-q-card p-6 md:p-8 lg:p-10">
          ...
          <p className="mt-4 text-base leading-7 text-q-muted md:text-lg md:leading-8">
            Tell us what tool, calculator, or AI utility you want to see next.
            Your request will be reviewed and scored for buildability.
          </p>
          ...
          <div className="mt-8 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the use case, inputs, outputs, or why this would be useful."
