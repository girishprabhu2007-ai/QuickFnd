    ...
    <main className="min-h-screen bg-gray-950 px-6 py-12 text-white">
      <section className="mx-auto max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-bold md:text-5xl">All Tools</h1>
          <p className="mt-4 max-w-3xl text-lg text-gray-400">
            Browse useful online tools built to help with developer workflows,
            formatting, productivity, and quick utility tasks.
          </p>
        </div>
